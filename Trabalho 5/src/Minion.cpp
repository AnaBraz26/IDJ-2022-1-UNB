...
Minion :: Minion(GameObject &associated, weak_ptr<GameObject> alienCenter, float arcOffsetDeg ): Component(associated){
    ...
    //     associated.box.x = go->box.center().x - 200;//- associated.box.w + 200;// - associated.box.w;
    //     associated.box.y = associated.box.h;// go->box.center().y;// - associated.box.h + 0;// - associated.box.h;
    // }
...
void Minion :: Shoot(Vec2 target){
    ...
    Vec2 pos = Vec2(associated.box.center().x + associated.box.w/2-sprite->GetWidth()/2,associated.box.center().y+associated.box.h/2 -sprite->GetHeight()/2);
    ...
    Bullet *bullet = new Bullet(*go, angle, 300, 10, 1024, "img/minionbullet1.png");
